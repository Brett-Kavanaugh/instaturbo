...
def turbo(nam):
    ...
    while turboin == True:
        ...
        if res.status_code == 404:
            ...
            dat1 = s.get(urlf)
            df = {
                'first_name': dat1.json()['first_name'],
                'email': dat1.json()['email'] ,
                'username': nam,
                'phone_number': dat1.json()['phone_number'],
                'gender': dat1.json()['gender'],
                'biography': dat1.json()['biography'],
                'external_url': dat1.json()['external_url'],
                'chaining_enabled': 'on'
            }
